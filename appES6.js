   ...
   class Income{
    ...
    return {
        ...
        deleteItem: function(type, id) {
            ...
            ids = data.allItems[type].map(current => current.id); //map() отличается от forEach() тем что возращает другой новый массив
        ...
        getPercentages: function () {
            let allPerc = data.allItems.exp.map(cur=>cur.getPercentages());
            return allPerc;
        },
...
let UIController = (()=>{
    ...
    return {
        ...
        displayPercentages: function (percentages) {
            ...
            let fields = document.querySelectorAll(DOMstrings.expensesPercentagesLabel); //и снова получаем nodelist
